...
def create_booking():
    ...
    current_app.logger.info(
        ...
        f"UserInParsedResourceAllowedIDs: {(current_user.id in locals().get('parsed_resource_allowed_ids', set())) if 'parsed_resource_allowed_ids' in locals() else 'N/A (admin path)'}, "
